    ...
    >
      <table style={{ position: "relative" }}>
        <>
          <tbody>
            <tr>
              {forDashBorad ? null : <th style={{ width: 1 }}>id</th>}
              <th>first name</th>
              <th>last name</th>
            ...
            {students.map((student) => (
              ...
              >
                {forDashBorad ? null : <td style={{ fontWeight: 550, fontSize: 8, width: 62 }}>{student.id.slice(0, 10).toUpperCase()} <br />  {student.id.slice(10, 20).toUpperCase()}</td>}
