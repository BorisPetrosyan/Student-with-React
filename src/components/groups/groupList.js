                  ...
                  {group.input ? (
                    <td style={{ padding: 0 }}>
                      <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        />
                        {errors.group && <p className='invalid fadeIn animatedd' style={{ margin: '-14px 0px 20px 21px', fontSize: 8 }}>{errors.group.message}</p>}
                        <span style={{ width: 5 }}>
                          <input
                        ...
                        <span style={{ width: 5, marginLeft: 16 }} className="animated fadeInRight">
                          <input
                            type="image"
                            className="animated fadeInRight"
                            style={{ marginBottom: -8, border: 0, width: 20 }}
                  ...
                  {group.input ? (
                    ...
                    <td style={{ padding: 0 }}>
                      ...
                      <select
                        ...
                        {faculties.filter((a) => a.facultyName !== oldGroupValue).map(faculty => (
